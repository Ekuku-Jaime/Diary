...
export var PatchQuestionFll = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
...
PatchQuestionFll.displayName = 'PatchQuestionFll';
export var PatchQuestionFllDimensions = {
  height: 16,
  width: 16
};